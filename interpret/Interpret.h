...
// Interpret - This class represents the entirety of the interpreter.
//
class Interpret : public ExecutionEngine, public InstVisitor<Interpret> {
...
public:
  explicit Interpret(std::unique_ptr<Module> M);
  ~Interpret() override;
